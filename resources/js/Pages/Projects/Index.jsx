...
export default function Projects(props) {
    ...
    const [alignment, setAlignment] = useState(tcc?.done ? "2" : tcc?.status ? "1" : "0");
    ...
    useEffect(() => {
        setAlignment(tcc?.done ? "2" : tcc?.status ? "1" : "0");
    }, [tcc]);
    ...
    const onToggleChange = (event, newAlignment) => {
        ...
        newAlignment === "2" || newAlignment === "1" || newAlignment === "0"
            ? Inertia.put(route("projects.status", tcc?.id), {
                  status: newAlignment,
              })
            : "";
    };
    ...
    return (
        <Authenticated
            auth={props.auth}
            errors={props.errors}
            header="Trabalho de Conclusão de Curso"
        >
            ...
            {auth.user.admin === 2 && (
                <>
                    <TextField
                        ...
                        select
                        onChange={(event) =>
                            onSearchStudentTCC(event, event.target.value)
                        }
                        variant="standard"
                    >
