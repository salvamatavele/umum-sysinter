...
export default function Edit(props) {
    const { users, auth, schedule } = usePage().props
    const { data, errors, put, processing, setData } = useForm({
        user_id: auth.user.admin === 2 ? schedule.user_id : auth.user.id,
    ...
    return (
        <Authenticated auth={props.auth} errors={props.errors} header="Actualizar Agenda">
            <Head title="Actualizar Agenda" />
            <Breadcrumbs aria-label="breadcrumb">
                <Link underline="hover" color="inherit" href={route('dashboard')}>
                    Painel
                </Link>

                <Typography color="text.primary">Actualizar Agenda</Typography>
            </Breadcrumbs>
            <Flash />
            <Box
                component="div"
            ...
            >
                ...
                <Box
                    ...
                    p={4}
                >
                    <Typography component="h6">Preencha os campos abaixo para actualizar nova reuniao/ encontro.</Typography>
                    <TextField
                        autoFocus
                        required
                        margin="normal"
