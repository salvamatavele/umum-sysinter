...
export default function Supervision(props) {
    // states
    const { supervisions } = usePage().props
        ...
        { field: "type", headerName: "Tipo", width: 150 },
        {
            ...
            renderCell: (params) => (
                <>
                    ...
                    <Tooltip title="Alocar supervisor">
                        <Link underline="hover" sx={{ m: 1, }} href={route('supervisions.create', params.row.id)}>
                            <AddLink color='success' />
                        </Link>
                    </Tooltip>
                </>
            ),
    ...
    return (
        <Authenticated auth={props.auth} errors={props.errors} header="Supervisores">
            ...
            <Breadcrumbs aria-label="breadcrumb">
                ...
                <Typography color="text.primary">Supervisors</Typography>
            </Breadcrumbs>
            <Flash />
            <Box sx={{ display: 'flex', justifyContent: 'end' }}>
                <Button variant="contained" color="primary" LinkComponent='a' href={route('users.create')}>Registar Supervisor</Button>
            </Box>
