...
export default function Add(props) {
    ...
    return (
        <Authenticated auth={props.auth} errors={props.errors} header="Registar Usuario">
            ...
            >
                ...
                <Box
                    ...
                    p={4}
                >
                    <Typography component="h6">Preencha os campos abaixo para registar novo usuario.</Typography>
                    <TextField
                        autoFocus
                        required
                        margin="normal"
